...
run_times = np.load('../bench_run_times/amd_ryzen_2700x/6_break_times.npy')
n = np.load('../bench_run_times/amd_ryzen_2700x/n.npy')
run_times1 = np.load('../bench_run_times/amd_ryzen_2700x/new_6_break_times.npy')
...
plt.figure()
plt.title('AMD Ryzen 2700x: 6 line segments')
plt.grid()
...
plt.semilogy()
plt.legend()
plt.savefig('../figs/ryz_six_breaks_new.png', bbox_inches='tight')
