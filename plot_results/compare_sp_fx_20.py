...
run_times = np.load('../bench_run_times/amd_fx_8350_titanXP_20/6_break_times.npy')
n = np.load('../bench_run_times/amd_fx_8350_titanXP_20/n.npy')
run_times1 = np.load('../bench_run_times/amd_fx_8350_titanXP_20_sp/6_break_times.npy')
...
plt.figure()
plt.title('AMD FX-8350: 20 line segments')
plt.grid()
...
plt.semilogy()
plt.legend()
plt.savefig('../figs/fx_twenty_breaks.png', bbox_inches='tight')
