...
run_times = np.load('../bench_run_times/intel_i5_6300u/6_break_times.npy')
n = np.load('../bench_run_times/intel_i5_6300u/n.npy')
...
plt.figure()
plt.title('Intel i5-6300u: 6 line segments')
plt.grid()
...
plt.semilogy()
plt.legend()
plt.savefig('../figs/i5_six_breaks.png', bbox_inches='tight')
